        ...
        return (
            <div className="container">
                ...
                <form action="">
                    ...
                    <input type="text" className="form-control w-50" value={this.state.username} onChange={event=>this.setState({username:event.target.value})} />
                    </div>
                    <br />
                    <div className="form-group">
                        <label htmlFor="">
                        ...
                        <textarea className="form-control w-50" value={this.state.comment} onChange={event=>this.setState({comments:event.target.value})}></textarea>
                    </div>
                    <div className="form-group">
                        <label htmlFor="">
                        Country
